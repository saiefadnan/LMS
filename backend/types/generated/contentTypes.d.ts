...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A course in the LMS platform';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
...
export interface ApiEnrollmentEnrollment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tracks which student is enrolled in which course';
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A lesson belonging to a course';
    displayName: 'Lesson';
    pluralName: 'lessons';
    singularName: 'lesson';
  };
...
export interface ApiProgressProgress extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tracks lesson completion per student';
...
export interface ApiQuizResultQuizResult extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Stores a student's quiz attempt and score";
